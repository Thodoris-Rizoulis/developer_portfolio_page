...
function Skills({ skills }: Props) {
  return (
    <motion.div
      ...
      className="min-h-screen md:h-screen flex flex-col relative text-center md:text-left xl:flex-row max-w-[2000px] xl:px-4 xl:px-10 py-8 sm:py-12 md:py-0 justify-start md:justify-center xl:space-y-0 mx-auto items-center"
    >
